...
module.exports = {
  testEnvironment: "node",
    ...
    moduleNameMapper: {
      ...
      '^(?!apollo-server-env|apollo-reporting-protobuf)(apollo-(?:federation|gateway|server|datasource|cache-control|tracing|engine)[^/]*|graphql-extensions)(?:/dist)?((?:/.*)|$)': '<rootDir>/../../packages/$1/src$2'
    },
    clearMocks: true,
    globals: {
      "ts-jest": {
